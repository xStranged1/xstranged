    ...
    return(
        <div className="container col-xxl-8 px-4 py-5">
            ...
            <div className="col-lg-6">
                ...
                <p className="lead" style={{textAlign: 'left'}}>Aprendí a programar a los 15 años en la escuela secundaria, desde entonces decidí dedicarme al campo de sistemas.</p>
